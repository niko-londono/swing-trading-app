      ...
      <div style={{ background:"#0c1318",border:"1px solid #00ff8822",borderRadius:"16px",padding:"18px",marginBottom:"14px" }}>
        ...
        <div style={{ marginTop:"14px",background:"#080d0f",borderRadius:"10px",padding:"12px" }}>
          ...
          <div style={{ fontSize:"10px",color:"#9e968f",lineHeight:"1.8" }}>
            ...
            3. Pega el código del archivo <span style={{ color:"#00ff88" }}>google-apps-script.js</span><br/>
            4. Implementar → Nueva implementación → App web<br/>
            5. Acceso: <span style={{ color:"#ffd700" }}>Cualquier persona</span><br/>
            6. Copia la URL y pégala arriba
          </div>
        </div>
      </div>
      <div>
